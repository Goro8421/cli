...
description: >
  Validates that docs/TELEMETRY.md accurately reflects the telemetry implementation.
  Use after any change touching internal/telemetry/, pkg/cmd/send-telemetry/,
  pkg/cmd/root/root.go, or docs/TELEMETRY.md.
---
